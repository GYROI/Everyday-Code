...
void loadAnotherGoddamnTextureThroughClick(SDL_Texture* texture){
    SDL_RenderClear(renderer);
    SDL_RenderCopy(renderer, texture, nullptr, nullptr);
    SDL_RenderPresent(renderer);
}

void DestroyAnotherGoddamnTextureThroughClick(SDL_Texture* texture){
...
int main() {
        ...
        while (SDL_PollEvent(&e) != 0) {
            if (e.type == SDL_QUIT) {
                ...
                if (e.button.button == SDL_BUTTON_LEFT) {
                    // Load a new texture when left mouse button is pressed
                    SDL_Texture* newTexture = loadTexture("C://Users//User//Desktop//SDL//no//gametext//wojak.bmp", renderer);
                    if (newTexture != nullptr) {
                        DestroyAnotherGoddamnTextureThroughClick(currentTexture);
    ...
    // Destroy the current texture before quitting
    DestroyAnotherGoddamnTextureThroughClick(currentTexture);
